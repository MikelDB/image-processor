...
const Template: Story<Props> = (args) => <FiltersContext.Provider value={context}><FilterCard {...args} /></FiltersContext.Provider>;
...
export const DefaultStory = () => <FiltersContext.Provider value={context}><FilterCard filter={mockFilter} /></FiltersContext.Provider>;
