...
const Template: Story = (args) => <FiltersContext.Provider value={context}><FiltersViewer {...args} /></FiltersContext.Provider>;

export const Playground = Template.bind({});

Playground.args = {};

export const DefaultStory = () => <FiltersContext.Provider value={context}><FiltersViewer /></FiltersContext.Provider>;
