...
export const ImagesContext = createContext({
    imageToProcess: '',
    processedImage: '',
    pushImage: (file: File, filters: Filter[]) => console.log('initialize undefined'),
    storeAndProcessImage: (file: File, filters: Filter[]) => console.log('initialize undefined'),
...
export const ImagesContextProvider: React.FC<GiftListContexProps> = ({children}) => {  
    ...
    const [ imageToProcessFile, setImageToProcessFile ] = useState(new File([""], "filename"));
    ...
    const context = { imageToProcess, storeImageToProcess, processedImage, pushImage, storeAndProcessImage };
